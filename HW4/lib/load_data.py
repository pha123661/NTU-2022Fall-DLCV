...
def load_data(args):
    ...
    if args.dataset_type == 'llff':
        ...
        images, poses, render_poses, hwf, K, i_split = load_blendedmvs_data(
            args.datadir)
        print('Loaded blendedmvs', images.shape,
              render_poses.shape, hwf, args.datadir)
        i_train, i_val, i_test = i_split
        ...
        print('Loaded tankstemple', images.shape,
              render_poses.shape, hwf, args.datadir)
        i_train, i_val, i_test = i_split
        ...
        images, poses, render_poses, hwf, i_split = load_nsvf_data(
            args.datadir)
        print('Loaded nsvf', images.shape,
              render_poses.shape, hwf, args.datadir)
        i_train, i_val, i_test = i_split
        ...
        images, masks, poses, render_poses, hwf, K, i_split = load_co3d_data(
            args)
        ...
        images, poses, render_poses, hwf, K, i_split = load_nerfpp_data(
            args.datadir)
        print('Loaded nerf_pp', images.shape, hwf, args.datadir)
        i_train, i_val, i_test = i_split

        near_clip, far = inward_nearfar_heuristic(
            poses[i_train, :3, 3], ratio=0.02)
        near = 0
